...
public class ImageInsertSettingsPanel extends JPanel {
    ...
    public JCheckBox getInlineImageCheckbox() {
        return inlineImageCheckbox;
    }
    ...
    private void initComponents() {
        ...
        nameInput.setToolTipText("leave empty to get a generated filename");
        label3 = new JLabel();
        ...
        panel2 = new JPanel();
        label2 = new JLabel();
        inlineImageCheckbox = new JCheckBox();
        ...
        //======== panel1 ========
        {
            ...
            //---- inlineImageCheckbox ----
            inlineImageCheckbox.setText("inline image");
            inlineImageCheckbox.setToolTipText("when selected, the image is not stored as a file but as an inline base64 text");
            panel1.add(inlineImageCheckbox,
    ...
    private JCheckBox inlineImageCheckbox;
